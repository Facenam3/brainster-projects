                            ...
                            <div class="flex justify-center items-center ml-16">
                                <nav class="font-medium ">
                                    <ul class="flex justify-between space-x-8">
                                        <li><a href="#"
                                                class="hover:border-b-2 hover:border-gray-500">Информативни Содржини</a>
                                        </li>
                                        <li><a href="#" class="hover:border-b-2 hover:border-gray-500">Едукативни
                                                Содржини</a></li>
                                        <li><a href="#" class="hover:border-b-2 hover:border-gray-500">Годишна
                                                Конференција</a></li>
                                        <li><a href="#" class="hover:border-b-2 hover:border-gray-500">Настани</a>
                                        </li>
                                        <li><a href="{{ route('user.blogs') }}"
                                                class="hover:border-b-2 hover:border-gray-500">Блог</a></li>
                                    </ul>
                                </nav>
                                <a href="#">
...
@else
    <div class="mt-3  flex justify-center items-center">
        <a href="{{ route('login') }}"
            class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-lg px-5 py-2 me-2 mb-2 dark:focus:ring-yellow-900">Login</a>
        <a href="{{ route('register') }}"
            class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-lg px-5 py-2 me-2 mb-2 dark:focus:ring-yellow-900">Register</a>
