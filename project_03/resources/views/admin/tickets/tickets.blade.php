<x-app-layout>
        ...
        <div class="py-12 px-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between align-center">
                    <h1 class="p-4 text-xl text-orange-500 font-medium ">Tickets</h1>
                    <a href="{{ route('admin.ticket-form') }}"
                            ...
                            @if ($tickets)
                                @foreach ($tickets as $ticket)
                                    <tr class="border-b-2">
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="#" data-id="{{ $ticket->id }}" class="text-blue-600 mx-2"
                                                id='edit'>
                                                <i class="fa-solid fa-pen-to-square"></i>
                                                Edit
                                            </a>

                                            <a href="#" data-id="{{ $ticket->id }}" class="text-red-600"
                                                id="delete">
    ...
    <script>
        $(document).on('click', '#edit', function(e) {
            ...
            window.location.href = `/admin/ticket-edit/${ticketId}`;
        });
