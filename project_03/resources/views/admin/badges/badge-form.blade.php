    ...
    <main>
        <div class="py-12 px-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <h1 class="p-4 text-xl text-orange-500 font-medium ">Create Badge</h1>
                <form action="{{ route('admin.badge-store') }}" method="POST" class=" mx-auto" id="addBadge">
                    @csrf
                    <div class="flex">
                        ...
                        <div class="w-full md:w-1/2 px-2">
                            <div class="mb-3">
                                ...
                                <textarea id="description" rows="5"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    placeholder="Write your description info..." name="description" required></textarea>
                            </div>
                        </div>
