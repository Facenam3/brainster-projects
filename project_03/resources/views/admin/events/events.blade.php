        ...
        <div class="py-12 px-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between align-center">
                    <h1 class="p-4 text-xl text-orange-500 font-medium ">Events</h1>
                    <a href="{{ route('admin.event-form') }}"
                ...
                <div class="body  border border-gray-400 rounded-md mt-3">
                    <form method="GET" action="#" class="p-4 bg-white rounded-md">
                        <input type="text" name="search" class="rounded-md mx-2" placeholder="Search events..."
                            ...
                            @if ($events)
                                @foreach ($events as $event)
                                    <tr class="border-b-2">
                                        ...
                                        <td class="px-6 py-2">
                                            {{ $event->speaker ? $event->speaker->name : 'No Speaker' }}
                                        </td>
                                        <td class="px-6 py-2">
                                            {{ $event->date }}
                                        </td>
                                        ...
                                        <td>
                                            <a href="#" data-id="{{ $event->id }}" class="text-blue-600 mx-2"
                                                id='edit'>
                                                <i class="fa-solid fa-pen-to-square"></i>
                                                Edit
                                            </a>

                                            <a href="#" data-id="{{ $event->id }}" class="text-red-600"
                                                id="delete">
                    ...
                    <div class="flex justify-between items-center mx-3 my-3">
                        ...
                        <div>
                            {{ $events->links('pagination.events') }}
                        </div>
                    </div>
                </div>
            </div>
