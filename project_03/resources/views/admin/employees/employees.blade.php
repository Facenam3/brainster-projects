        ...
        <div class="py-12 px-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between align-center">
                    <h1 class="p-4 text-xl text-orange-500 font-medium ">Employees</h1>
                    <a href="{{ route('admin.employee-form') }}"
                ...
                <div class="body  border border-gray-400 rounded-md mt-3">
                    <form method="GET" action="#" class="p-4 bg-white rounded-md">
                        <input type="text" name="search" class="rounded-md mx-2" placeholder="Search employees..."
                            ...
                            @if ($employees)
                                @foreach ($employees as $employee)
                                    <tr class="border-b-2">
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="#" data-id="{{ $employee->id }}" class="text-blue-600 mx-2"
                                                id='edit'>
                                                <i class="fa-solid fa-pen-to-square"></i>
                                                Edit
                                            </a>

                                            <a href="#" data-id="{{ $employee->id }}" class="text-red-600"
                                                id="delete">
                    ...
                    <div class="flex justify-between items-center mx-3 my-3">
                        ...
                        <div>
                            {{ $employees->links('pagination.employees') }}
                        </div>
                    </div>
                </div>
            </div>
