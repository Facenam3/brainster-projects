    ...
    <main>
        <div class="py-12 px-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <form action="{{ route('admin.update-speaker', $speaker->id) }}" method="POST" class=" mx-auto"
                    id="addSPeaker">
                    @csrf
                    @method('PUT')
                    <div class="flex">
                        <div class="w-full md:w-1/2 px-2">
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" name="name"
                                    ...
                                    placeholder="Full Name" required value="{{ old('name', $speaker->name) }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                @if ($speaker->photo)
                                    <div class="mb-2">
                                        <img src="{{ Storage::url($speaker->photo) }}" alt="Selected Image"
                        ...
                        <div class="w-full md:w-1/2 px-2">
                            <div class="mb-4">
                                ...
                                <textarea id="bio" rows="6"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    placeholder="Write your bio here..." name="bio" required>{{ old('bio', $speaker->bio) }}</textarea>
                            </div>
